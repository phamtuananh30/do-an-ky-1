    ...
    <div class="panel-heading"> 
     <div class="row"> 
      ...
      <div class="col col-xs-6 text-right"> 
                    <a href="albums_add.php"class="btn btn-sm btn-primary btn-create">Add</a>
      </div> 
     </div> 
    </div> 
...
foreach($albums_List as $item) {
    echo '<tr>
            <td align="center"><a href="albums_edit.php?id='.$item['id'].'" class="btn btn-default"><em class="fa fa-pencil"></em></a> <a href="adm_delete.php?albums_id='.$item['id'].'" class="btn btn-danger"><em class="fa fa-trash"></em></a></td> 
