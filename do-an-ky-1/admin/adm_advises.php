...
foreach($form_List as $item) {
    echo '<tr>
            <td align="center"><a href="adm_edit_advises.php?id='.$item['id'].'" class="btn btn-default"><em class="fa fa-pencil"></em></a> <a href="adm_delete.php?advises_id='.$item['id'].'" class="btn btn-danger"><em class="fa fa-trash"></em></a></td> 
