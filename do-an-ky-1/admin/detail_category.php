...
$sql = "select * from detail_category";
$datail_List = executeResult($sql);
?>
<!DOCTYPE html>
<html lang="en">
<head>
   ...
   <div class="panel panel-default panel-table"> 
    <div class="panel-heading"> 
     <div class="row"> 
      <div class="col col-xs-6"> 
       <h3 class="panel-title">List Datail_Category</h3> 
      </div> 
      <div class="col col-xs-6 text-right"> 
                    <a href="detail_category_add.php"class="btn btn-sm btn-primary btn-create">Add</a>
      </div> 
     </div> 
    </div> 
    <div class="panel-body"> 
     <table method="post" class="table table-striped table-bordered table-list"> 
      ...
      <?php
$index = 0;
foreach($datail_List as $item) {
    echo '<tr>
            <td align="center">
            <a href="detail_category_edit.php?id='.$item['id'].'" class="btn btn-default">
            <em class="fa fa-pencil"></em></a> 
            <a href="adm_delete.php?detai_id='.$item['id'].'" class="btn btn-danger"><em class="fa fa-trash"></em></a></td> 
